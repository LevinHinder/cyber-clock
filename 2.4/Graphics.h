...
namespace UI {
    ...
    void text(String str, int x, int y, int size, uint16_t color, uint16_t bg = Colors::BG);
    void textCentered(String str, int y, int size, uint16_t color, uint16_t bg = Colors::BG);
    void textCenteredX(String str, int x_start, int x_end, int y, int size, uint16_t color, uint16_t bg = Colors::BG);
